...
\skipline
2. 一般性的，对任意多项式$f(x) = c_0 + c_1 x + c_2 x^2 + \ldots $，有$f(A) =   P^{-1} \mathrm{diag}\{f(\lambda_1), f(\lambda_2), \ldots\} P$。

\skipline
3. 对一般解析函数$f(x)$可以假设它能够展开为收敛的级数并定义$f(A) =   P^{-1} \mathrm{diag}\{f(\lambda_1), f(\lambda_2), \ldots\} P$。
