...
{\tiny
\bea
 |\calM|^2 &=& \frac{q^4}{16 \omega_\gamma\omega_\gamma'} \sum_{s_e, s_\gamma, s_e', s_\gamma'}\left\vert\bar{u}_{p_e',s'_e} \left(\slashed{\vece}^*_{p_\gamma',s_\gamma'}\frac{\ii }{\slashed{p}_e+\slashed{p}_\gamma-m}\slashed{\vece}_{p_\gamma,s_\gamma}+\slashed{\vece}_{p_\gamma,s_\gamma}\frac{\ii}{\slashed{p}_e-\slashed{p}_\gamma'-m}\slashed{\vece}^*_{p_\gamma',s_\gamma'} \right) u_{p_e,s_e}   \right\vert^2 \newl
...
&&\times  \left(\bar{u}_{p_e'} \left(\gamma^\mu\frac{\ii}{\slashed{p}_e+\slashed{p}_\gamma-m}\gamma^\nu+\gamma^\nu\frac{\ii}{\slashed{p}_e-\slashed{p}_\gamma'-m}\gamma^\mu\right)  u_{p_e}  \right)^\dagger \newl
&& \times\left(\bar{u}_{p_e'} \left(\gamma^\alpha \frac{\ii}{\slashed{p}_e+\slashed{p}_\gamma-m}\gamma^\beta +\gamma^\beta \frac{\ii}{\slashed{p}_e-\slashed{p}_\gamma'-m}\gamma^\alpha \right)u_{p_e}  \right) \newl
&=& \frac{q^4}{16 \omega_\gamma\omega_\gamma'} \sum_{\rm spins} (-g_{\alpha\mu})(- g_{\nu\beta} )\left(\bar{u}_{p_e'} \left(\gamma^\mu\frac{\ii}{\slashed{p}_e+\slashed{p}_\gamma-m}\gamma^\nu+\gamma^\nu\frac{\ii}{\slashed{p}_e-\slashed{p}_\gamma'-m}\gamma^\mu\right)  u_{p_e}  \right)^\dagger \newl
&& \times\left(\bar{u}_{p_e'} \left(\gamma^\alpha \frac{\ii}{\slashed{p}_e+\slashed{p}_\gamma-m}\gamma^\beta +\gamma^\beta \frac{\ii}{\slashed{p}_e-\slashed{p}_\gamma'-m}\gamma^\alpha \right)u_{p_e}  \right) 
\eea
}
\ech
...
{\tiny
\bea
|\calM|^2 &=& \frac{q^4}{16 \omega_\gamma\omega_\gamma'} \sum_{\rm spins} \bar{u}_{p_e}\left(\gamma^\nu\frac{1}{\slashed{p}_e+\slashed{p}_\gamma-m}\gamma^\mu+\gamma^\mu\frac{1}{\slashed{p}_e-\slashed{p}_\gamma'-m}\gamma^\nu \right)u_{p_e'}    \newl
&& \times \bar{u}_{p_e'} \left(\gamma_\mu \frac{1}{\slashed{p}_e+\slashed{p}_\gamma-m}\gamma_\nu+\gamma_\nu \frac{1}{\slashed{p}_e-\slashed{p}_\gamma'-m}\gamma_\mu \right)u_{p_e}  \newl
&=& \frac{q^4}{16 \omega_\gamma\omega_\gamma'} \sum_{\rm spins} \mathrm{Tr}\left[ \bar{u}_{p_e}\left(\gamma^\nu\frac{1}{\slashed{p}_e+\slashed{p}_\gamma-m}\gamma^\mu+\gamma^\mu\frac{1}{\slashed{p}_e-\slashed{p}_\gamma'-m}\gamma^\nu\right) u_{p_e'}     \right.\newl
&& \times \left. \bar{u}_{p_e'} \left(\gamma_\mu \frac{1}{\slashed{p}_e+\slashed{p}_\gamma-m}\gamma_\nu+\gamma_\nu \frac{1}{\slashed{p}_e-\slashed{p}_\gamma'-m}\gamma_\mu \right)u_{p_e} \right] \newl
&=& \frac{q^4}{16 \omega_\gamma\omega_\gamma'} \sum_{\rm spins} \mathrm{Tr}\left[ u_{p_e}\bar{u}_{p_e}\left(\gamma^\nu\frac{1}{\slashed{p}_e+\slashed{p}_\gamma-m}\gamma^\mu+\gamma^\mu\frac{1}{\slashed{p}_e-\slashed{p}_\gamma'-m}\gamma^\nu\right) u_{p_e'} \bar{u}_{p_e'}    \right.\newl
&& \times \left.  \left(\gamma_\mu \frac{1}{\slashed{p}_e+\slashed{p}_\gamma-m}\gamma_\nu+\gamma_\nu \frac{1}{\slashed{p}_e-\slashed{p}_\gamma'-m}\gamma_\mu \right)\right]
\eea
}
...
{\tiny
\bea
K &=&  \mathrm{Tr}\left[ (\slashed{p}_e+m)\left(\gamma^\nu\frac{1}{\slashed{p}_e+\slashed{p}_\gamma-m}\gamma^\mu+\gamma^\mu\frac{1}{\slashed{p}_e-\slashed{p}_\gamma'-m}\gamma^\nu\right) (\slashed{p}_e'+m)    \right.\newl
&& \times \left.  \left(\gamma_\mu \frac{1}{\slashed{p}_e+\slashed{p}_\gamma-m}\gamma_\nu+\gamma_\nu \frac{1}{\slashed{p}_e-\slashed{p}_\gamma'-m}\gamma_\mu \right)\right]
\eea
}
...
{\scriptsize
\bea
K &=&  \mathrm{Tr}\left[ (\slashed{p}_e+m)\left(\gamma^\nu\frac{\slashed{p}_e+\slashed{p}_\gamma+m}{2p_ep_\gamma}\gamma^\mu-\gamma^\mu\frac{\slashed{p}_e-\slashed{p}_\gamma'+m}{2p_e p_\gamma'}\gamma^\nu\right) (\slashed{p}_e'+m)    \right.\newl
&& \times \left.  \left(\gamma_\mu \frac{\slashed{p}_e+\slashed{p}_\gamma+m}{2p_e p_\gamma}\gamma_\nu-\gamma_\nu \frac{\slashed{p}_e-\slashed{p}_\gamma'+m}{2p_ep_\gamma'}\gamma_\mu \right)\right]
\eea
}
}
\ech
