...
现在考虑初态或者末态自旋未知，需要把散射概率（散射振幅的平方）对所有自旋求平均的情况。
...
{\scriptsize
\be
 |\calM|^2 = \frac{q^4}{64 \omega_\gamma\omega_\gamma'} \sum_{\rm spins}\left\vert\bar{u}_{p_e'} \slashed{\vece}^*_{p_\gamma'}\left(\frac{\ii}{\slashed{p}_e+\slashed{p}_\gamma-m}+\frac{\ii}{\slashed{p}_e-\slashed{p}_\gamma'-m}\right)\slashed{\vece}_{p_\gamma} u_{p_e}   \right\vert^2
\ee
}
\ech
\end{frame}
