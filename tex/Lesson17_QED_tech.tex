...
{\tiny
\bea
 \trof{\gamma_\nu\frac{\slashed{p}_e+m}{2\omega_e} \gamma^\nu \left(\frac{-\ii}{\slashed{p}_e+\slashed{p}_\gamma-m}+\frac{-\ii}{\slashed{p}_e-\slashed{p}_\gamma'-m}\right)\gamma^\mu  \frac{\slashed{p}_e'+m}{2\omega_e'} \gamma_\mu \left(\frac{\ii}{\slashed{p}_e+\slashed{p}_\gamma-m}+\frac{\ii}{\slashed{p}_e-\slashed{p}_\gamma'-m}\right) } 
\eea
}
...
{\tiny
\be
K =  \trace\left[(\slashed{p}_e-2m) \left(\frac{\slashed{p}_e+\slashed{p}_\gamma+m}{2 p_e p_\gamma}-\frac{\slashed{p}_e-\slashed{p}_\gamma'+m}{2p_e p_\gamma'}\right) (\slashed{p}_{e}'-2m) \left(\frac{\slashed{p}_e'+\slashed{p}_\gamma'+m}{2 p_e p_\gamma}-\frac{\slashed{p}_e'-\slashed{p}_\gamma+m}{2 p_e' p_\gamma}\right)\right]
\ee
}
