...
&=& \sum_{i=0}^{n-1} \frac{1}{n}\sum_{j=0}^{n-1} y_j* e^{-\frac{2\pi i j}{n} \ii} \sum_{k=0}^{n-1} e^{\frac{2\pi i k}{n} \ii} \newl
&=& \sum_{j,k} y_j*y_k \frac{1}{n} \sum_{i=0}^{n-1}  e^{\frac{2\pi i (k-j)}{n} \ii}  \newl
