...
{\scriptsize
\be
 |\calM|^2 = \frac{q^4}{4 \omega_\gamma\omega_\gamma'} \frac{1}{4}\sum_{s_e, s_\gamma, s_e', s_\gamma'}\left\vert\bar{u}_{p_e',s'_e} \slashed{\vece}^*_{p_\gamma',s_\gamma'}\left(\frac{\ii}{\slashed{p}_e+\slashed{p}_\gamma-m}+\frac{\ii}{\slashed{p}_e-\slashed{p}_\gamma'-m}\right)\slashed{\vece}_{p_\gamma,s_\gamma} u_{p_e,s_e}   \right\vert^2
\ee
}
