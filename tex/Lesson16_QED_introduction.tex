...
& \times &\left\vert\sum_{s_e, s_\gamma, s_e', s_\gamma'}\bar{u}_{p_e',s'_e}\left( \slashed{\vece}^*_{p_\gamma',s_\gamma'}\frac{\ii}{\slashed{p}_e+\slashed{p}_\gamma-m}\slashed{\vece}_{p_\gamma,s_\gamma}+ \slashed{\vece}^*_{p_\gamma',s_\gamma'}\frac{\ii}{\slashed{p}_e-\slashed{p}_\gamma'-m}\slashed{\vece}_{p_\gamma,s_\gamma}\right) u_{p_e,s_e}   \right\vert^2
\eea
下面我们来讨论计算它的技巧。
