...
上面的两种情况可以统一写为：
\be
 \contr{\hatphi(x)}{\hatphi(y)} = \frac{\ii}{(2\pi)^4} \int d^4k\, \frac{e^{-\ii k(x-y)}}{k^2-m^2+\ii\epsilon} 
\ee
...
\be
 \frac{\ii}{(2\pi)^4} \int d^4k\, \frac{e^{-\ii k(x-y)}}{k^2-m^2+\ii\epsilon} = \frac{1}{(2\pi)^3} \int \frac{d^3\veck}{2\omega}\, e^{\ii\omega(x^0-y^0)+\ii \veck\cdot(\vecx-\vecy)}
\ee
上式是对$\veck$全空间积分，所以可以把$\veck$换成$-\veck$，得到
\be
 \frac{\ii}{(2\pi)^4} \int d^4k\, \frac{e^{-\ii k(x-y)}}{k^2-m^2+\ii\epsilon}  = \frac{1}{(2\pi)^3} \int \frac{d^3\veck}{2\omega}\, e^{\ii k(x-y)}
\ee
}
\ech
\end{frame}
...
&& = (-\ii g)^2 \frac{(d^3\veck)^2}{4\sqrt{\omega_1\omega_2\omega_3\omega_4}}  \frac{1}{(2\pi)^{10}} \int d^4x \int d^4y \int d^4 p\, e^{-\ii (p_1+p_2) x + \ii(p_3+p_4)y} \frac{\ii e^{-\ii p(x-y)}}{p^2-m^2+i\epsilon} \newl
