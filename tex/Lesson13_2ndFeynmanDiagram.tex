...
$$\torder{X_1X_2\ldots X_n} = \pm \torder{X_1X_2\ldots X_{i-1}X_{i+1}\ldots X_n} X_i$$  
前面的$\pm$符号：当且仅当$X_i$是费米子的产生或湮灭算符，且$X_{i+1}X_{i+2}\ldots X_n$中有奇数个费米子的产生或湮灭算符时才取"$-$"号
\skipline
...
\bch
{\small
任取一项$X_1X_2\ldots X_{i-1}X_{i+1}\ldots X_n$含某些收缩的正规乘积，不妨设所有收缩给出的因子为$\lambda$, 剩下的未收缩掉的正规乘积为
$$\rorder{X_{j_1}X_{j_2}\ldots X_{j_k} X_{j_{k+1}} \ldots X_{j_m}}$$
其中$1\le j_1<j_2<\ldots<j_k<i < j_{k+1}< \ldots < j_m\le n$。
\skipline

我们来证明
\bea
&&\rorder{X_{j_1}X_{j_2}\ldots X_{j_k} X_{j_{k+1}} \ldots X_{j_m}}X_i \newl
&=& \rorder{X_{j_1}X_{j_2}\ldots X_{j_k}X_i X_{j_{k+1}} \ldots X_{j_m}} \newl
&& + \rorder{\contraction{}{X_{j_1}}{X_{j_2}\ldots X_{j_k}}{X_i}X_{j_1}X_{j_2}\ldots X_{j_k}X_i X_{j_{k+1}} \ldots X_{j_m}} \newl
&& + \rorder{\contraction{X_{j_1}}{X_{j_2}}{\ldots X_{j_k}}{X_i}X_{j_1}X_{j_2}\ldots X_{j_k}X_i X_{j_{k+1}} \ldots X_{j_m}}\newl
&& \ldots \newl
&& + \rorder{\contraction{X_{j_1}X_{j_2}\ldots X_{j_k}}{X_i}{X_{j_{k+1}}\ldots}{X_{j_m}}X_{j_1}X_{j_2}\ldots X_{j_k}X_i X_{j_{k+1}}\ldots X_{j_m}}\newl
\eea
}
\ech
\end{frame}
