...
\bea
\torder{e^{-\ii\int_{-\infty}^\infty \hat{H}_I dt}}\approx 1-\ii\int d^4x\,\frac{g}{3!}\hat\phi(x)^3  \\
&& -\frac{1}{2}\torder{\left(\int d^4x\,\frac{g}{3!}\hat\phi(x)^3\right)\left(\int d^4y\,\frac{g}{3!}\hat\phi(y)^3\right)}- \ii\int d^4x\, \frac{\lambda}{4!}\hat\phi^4 
\ee
